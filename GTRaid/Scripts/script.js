...
var hero19= new Hero("奧格瑪(2專)","Oghma","dark","3","airborne","injured","Rifle","");
...
var hero74= new Hero("維尼特","1","dark","3","airborne","downed","Rifle","");
...
var weapon18= new Weapon("引人注目","Prominence","injured","fire","Epic","Express","Plitvice","Two-Handed");
...
var weapon40= new Weapon("藍色尖刺","Blue Spear","airborne","water","Epic","Express","AA72","Rifle");
...
var weapon44= new Weapon("納米粒子加速器","1","airborne","dark","Epic","Express","1","Rifle");
...
var weapon48= new Weapon("瑪奇頓破壞者","Magiton Buster","Downed","light","Legend","Express","Sohee","Rifle");
var weapon49= new Weapon("薩倫加弓","Sarnga","injured","earth","Epic","Express","Tinia","Bow");
var weapon50= new Weapon("千雷","Thousand Thunder","Downed","water","Epic","Express","Garam","Bow");
var weapon51= new Weapon("聖母讚","Magnificat","Downed","light","Epic","Express","Gabriel","Bow");
var weapon52= new Weapon("派蒙的碎片III","Paimon's Fragment III","airborne","fire","Epic","Express","Pymon","Bow");
var weapon53= new Weapon("掠奪者","Marauder","airborne","water","Legend","Express","Catherine","Bow");
var weapon54= new Weapon("奧伯隆","Oberon","airborne","earth","Legend","Express","Aoba","Bow");
var weapon55= new Weapon("利貝拉Type.B","Libera Type.B","airborne","normal","Legend","Express","None","Bow");
var weapon56= new Weapon("黃龍弓","Yellow Dragon's Bow","injured","light","Epic","Normal","None","Bow");
var weapon57= new Weapon("恐懼之翼","Wing of Terror","injured","dark","Legend","Normal","None","Bow");
var weapon58= new Weapon("梅麗爾","Mayreel","injured","earth","Epic","Express","Bari","Basket");
var weapon59= new Weapon("至聖寶珠","Sage Bead","Downed","normal","Epic","Express","Nari","Basket");
var weapon60= new Weapon("香格里拉","Shangri La","airborne","fire","Epic","Express","Miya","Basket");
var weapon61= new Weapon("紫魄","Furfur","Downed","dark","Epic","Express","Noxia","Basket");
var weapon62= new Weapon("讚美詩","Benedictus","injured","light","Epic","Express","Eleanor","Basket");
var weapon63= new Weapon("蝕","Eclipse","injured","light","Epic","Express","Priscilla","Basket");
var weapon64= new Weapon("萬波息筆","Bringer of Tranquility","Downed","water","Epic","Express","Ara","Basket");
var weapon65= new Weapon("海洋呼喚","Ocean Call","Downed","normal","Epic","Express","SummerLoraine","Basket");
var weapon66= new Weapon("鏡花水月","Elusive Reflection","airborne","normal","Epic","Express","None","Basket");
var weapon67= new Weapon("玄山拳祕笈","Secret Book of the Shen Mountain Fist","Downed","light","Epic","Express","ChunRyeo","Basket");
var weapon68= new Weapon("海洋之淚","Oceans Tear","injured","water","Epic","Express","Sia","Basket");
var weapon69= new Weapon("千變萬化","Infinite Change","Downed","normal","Epic","Express","Eunha","Basket");
var weapon70= new Weapon("艾瑪","Emma","Downed","normal","Legend","Express","Loraine","Basket");
var weapon71= new Weapon("冰霜傑克","Jack Frost","Downed","water","Legend","Express","Favi","Basket");
var weapon72= new Weapon("好奇解答者","Curiosity Solver","injured","dark","Legend","Express","Gremory","Basket");
var weapon73= new Weapon("閃光寶石籃","Shining Jewel Basket","Downed","light","Legend","Normal","None","Basket");
var weapon74= new Weapon("鯊魚籃","Shark Basket","airborne","water","Unique","Normal","None","Basket");
var weapon75= new Weapon("天使之聲","Angel Voice","airborne","normal","Epic","Express","IdolCaptainEva","Staff");
var weapon76= new Weapon("亞馬洛克","Amarok","injured","dark","Epic","Express","Lupina","Staff");
var weapon77= new Weapon("解放者","Liberator","injured","light","Epic","Express","FuturePrincess","Staff");
var weapon78= new Weapon("彌賽亞","Messiah","airborne","water","Epic","Express","Veronica","Staff");
var weapon79= new Weapon("幻想曲","Fantasia","airborne","fire","Epic","Express","Lucy","Staff");
var weapon80= new Weapon("艾奎諾克斯","Equinox","airborne","earth","Epic","Express","Kamael","Staff");
var weapon81= new Weapon("愛的教訓","Mind Snap","injured","normal","Epic","Express","Kanna","Staff");
var weapon82= new Weapon("斷開鎖練","Unchained","injured","water","Epic","Express","Hana","Staff");
var weapon83= new Weapon("獵頭者","Head Hunter","airborne","water","Epic","Express","Andras","Staff");
var weapon84= new Weapon("攻無不克","Fail-not","injured","dark","Epic","Express","CorpsCommander","Staff");
var weapon85= new Weapon("傑洛士的權杖","Xellos' Staff","airborne","dark","Epic","Express","Xelloss","Staff");
var weapon86= new Weapon("黑魔杖","Black Rod","airborne","fire","Epic","Express","Popp","Staff");
var weapon87= new Weapon("女巫之心","Witch Heart","injured","water","Legend","Express","Coco","Staff");
var weapon88= new Weapon("新月","Crescent Moon","Downed","dark","Legend","Express","Karina","Staff");
var weapon89= new Weapon("正義","Justice","airborne","light","Legend","Express","Eva","Staff");
var weapon90= new Weapon("太陽神","Helios","Downed","fire","Legend","Express","Dolf","Staff");
var weapon91= new Weapon("龍之怒","Wrath of Dragon","injured","fire","Legend","Express","Girgas","Staff");
var weapon92= new Weapon("黃戰士的奧秘權杖","Yellow's Mysterious Staff","injured","light","Epic","Normal","None","Staff");
var weapon93= new Weapon("光之權威權杖","Authority of Light Staff","injured","light","Epic","Normal","None","Staff");
var weapon94= new Weapon("青翠寶石權杖","Jewel of Verdure Staff","injured","earth","Legend","Normal","None","Staff");
var weapon95= new Weapon("收割權杖","Harvest Staff","Downed","earth","Unique","Normal","None","Staff");
var weapon96= new Weapon("森林看手權杖","Forest Keeper Staff","airborne","earth","Unique","Normal","None","Staff");
var weapon97= new Weapon("純潔的心","Pure Mind","airborne","normal","Epic","Express","None","Gauntlet");
var weapon98= new Weapon("歐魯斯","Ouros","airborne","earth","Epic","Express","Alef","Gauntlet");
var weapon99= new Weapon("伊弗利特","Ifrit","Downed","fire","Epic","Express","Scintilla","Gauntlet");
var weapon100= new Weapon("辦公用品","Office Supply","Downed","earth","Epic","Express","Parvati","Gauntlet");
var weapon101= new Weapon("暮光","Twilight","Downed","dark","Epic","Express","Claude","Gauntlet");
var weapon102= new Weapon("火山核心","Volcanic Core","injured","fire","Epic","Express","None","Gauntlet");
var weapon103= new Weapon("威望","Prestige","Downed","earth","Epic","Express","MadPandaTrio","Gauntlet");
